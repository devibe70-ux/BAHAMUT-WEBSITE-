...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    id: 'BM-ART-32-1',
    slug: 'bm-art-32-1',
    title: 'BahaMut Heavyweight Street Graphic Tee',
    category: 'TEE',
    description: 'BahaMut Streetwear Graphic Tee. Crafted from 240 GSM 100% Combed Cotton at Ahmedabad mills. Billed & fulfilled by DE VIBE, Ambawadi, Ahmedabad (GSTIN: 24ASHPS9777R1ZE). HSN 61091000.',
    target_demographic: 'YOUTH',
    fabric_details: '100% Combed Cotton • 240 GSM Heavyweight',
    price: 899,
    original_mrp: 1499,
    stock_quantity: 35,
    rating: 4.9,
  ...
  },
  {
    id: 'BM-ART-35-1',
    slug: 'bm-art-35-1',
    title: 'BahaMut Draconic Street Hoodie',
    category: 'TEE',
    description: 'BahaMut Heavyweight Streetwear Hoodie. Crafted from 350 GSM Fleece Cotton at Ahmedabad mills. Billed & fulfilled by DE VIBE, Ambawadi, Ahmedabad (GSTIN: 24ASHPS9777R1ZE). HSN 61091000.',
    target_demographic: 'YOUTH',
    fabric_details: '100% Fleece Cotton • 350 GSM Heavyweight',
    price: 1699,
    original_mrp: 2499,
    stock_quantity: 38,
    rating: 4.9,
...
export function getProducts(): Product[] {
  if (typeof window !== 'undefined') {
    const saved = localStorage.getItem('bahamut_smartbiz_products_v25');
    if (saved) {
      try {
...
export function saveProduct(product: Product): Product[] {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('bahamut_smartbiz_products_v25', JSON.stringify(updated));
  }
  return updated;
}
...
export function deductStockForOrder(items: CartItem[]): Product[] {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('bahamut_smartbiz_products_v25', JSON.stringify(products));
  }
  return products;
}
