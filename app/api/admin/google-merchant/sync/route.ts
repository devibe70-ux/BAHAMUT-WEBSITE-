...
export async function POST(req: Request) {
  try {
    ...
    // Standardized Google Merchant & Amazon SmartBiz verified 14 Master Product feed with paired 5-size matrices
    const googleMerchantProducts = [
      ...
      },
      {
        ...
        category: 'BOTTOMWEAR',
        description: 'Heavyweight 100% Woven Cotton Denim Jeans engineered in Ahmedabad.',
        price: 1599,
        original_mrp: 2399,
        stock_quantity: 45,
        images: ['/images/products/bahamut-22-2-selvedge-denim-1.jpg'],
