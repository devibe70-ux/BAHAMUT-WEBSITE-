...
- **Storefront Selling Price**: ₹${p.price} INR (Tax Inclusive)
- **Original MRP**: ₹${p.original_mrp} INR
- **Category**: ${p.category}
- **Statutory HSN Code**: 62034290 (Chapter 62 Articles of Apparel - Men's Cotton Trousers/Jeans)
- **Fabric & Mill Details**: ${p.fabric_details || '100% Woven Cotton Denim (Ambawadi, Ahmedabad)'}
...
> This document provides the complete, un-truncated database of BahaMut by DE VIBE for Large Language Models (LLMs) and Small Language Models (SLMs).
...
- **Authorized Merchant / Billing Merchant Entity**: DE VIBE
- **GSTIN**: 24ASHPS9777R1ZE (Gujarat State Code 24)
- **Statutory Apparel GST**: 5.00% (Intra-State: 2.5% CGST + 2.5% SGST; Inter-State: 5.0% IGST)
- **Registered Physical Operations**: Ambawadi, Ahmedabad, Gujarat, India - 380015
...
## Commercial Policies
1. **Flat Storefront Price**: ₹1,499.00 INR (Tax Inclusive) across all BahaMut Master Products.
2. **Partial Cash on Delivery (COD)**: Flat ₹200 advance online deposit via Cashfree Payments Gateway; balance paid cash at doorstep.
3. **Prepaid Checkout Discount**: Extra 5% Instant Discount applied automatically on full online prepaid payment.
4. **Shipping**: Free Express Delivery nationwide from Ambawadi, Ahmedabad (2–4 business days).
